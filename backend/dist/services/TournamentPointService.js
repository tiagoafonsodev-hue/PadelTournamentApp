...
exports.tournamentPointService = exports.TournamentPointService = void 0;
...
class TournamentPointService {
     ...
     */
    async awardTournamentPoints(tournamentId, finalPositions) {
        ...
        for (const { position } of finalPositions) {
            if (!pointsMap.has(position)) {
                const points = await this.getPointsForPosition(tournament.userId, tournament.category, position);
     ...
     */
    async recalculatePlayerPoints(playerId) {
     ...
     */
    async getPointConfiguration(userId, category) {
     ...
     */
    async savePointConfiguration(userId, category, points) {
     ...
     */
    async getAllPointConfigurations(userId) {
        const result = {
...
exports.TournamentPointService = TournamentPointService;
exports.tournamentPointService = new TournamentPointService();
//# sourceMappingURL=TournamentPointService.js.map